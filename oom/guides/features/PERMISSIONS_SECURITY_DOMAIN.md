...
| **CREATOR** | Creator | Record create access | Entity record creation |
| **READER** | Reader | Record read access | Entity record read |
| **UPDATOR** | Updator | Record update access | Entity record update |
| **DELETOR** | Deletor | Record delete access | Entity record delete |
...
**6. CRUD:**
- `CREATOR` - Entity record creation
- `READER` - Entity record read
- `UPDATOR` - Entity record update
- `DELETOR` - Entity record delete

### Software Development Lifecycle Example

**Entity: FEATURE_REQUEST**

Decided by the entries in the database
