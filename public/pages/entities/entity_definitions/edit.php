...
$pageTitle = 'Edit Entity Definition: ' . $entity->name;
        ...
        <div class="col-md-8 offset-md-2">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/entity_definitions/<?= $entity->id ?>"><?= htmlspecialchars($entity->name ?? '') ?></a></li>
            ...
            <!-- Header -->
            <h1 class="mb-4">
                <i class="bi bi-pencil"></i> Edit Entity Definition
            </h1>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="/entity_definitions/<?= $entity->id ?>/update" class="needs-validation" novalidate>
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?= errors('description') ? 'is-invalid' : '' ?>"
                                      id="description"
                                      name="description"
                                      rows="4"><?= old('description') ?? $entity->description ?></textarea>
                            <?php $field = 'description'; include __DIR__ . '/../../../../views/components/form-errors.php'; ?>
                        </div>

                        <div class="d-flex justify-content-between">
                            <a href="/entity_definitions/<?= $entity->id ?>" class="btn btn-secondary">
                                <i class="bi bi-arrow-left"></i> Cancel
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save"></i> Update Entity Definition
                            </button>
                        </div>
                    </form>
                </div>
