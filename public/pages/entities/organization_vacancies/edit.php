<?php
/**
 * Edit Organization Vacancy Page
 */
        ...
        <div class="col-md-8 offset-md-2">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/organization_vacancies/<?= $vacancy->id ?>">Vacancy #<?= $vacancy->id ?></a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="/organization_vacancies/<?= $vacancy->id ?>/update" class="needs-validation" novalidate>
                        <?= csrf_field() ?>
                        <input type="hidden" name="version" value="<?= $vacancy->version ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select <?= errors('organization_id') ? 'is-invalid' : '' ?>"
                                ...
                                <?php foreach ($organizations as $organization): ?>
                                    <option value="<?= $organization->id ?>" <?= old('organization_id', $vacancy->organization_id) == $organization->id ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select <?= errors('popular_position_id') ? 'is-invalid' : '' ?>"
                                ...
                                <?php foreach ($positions as $position): ?>
                                    <option value="<?= $position->id ?>" <?= old('popular_position_id', $vacancy->popular_position_id) == $position->id ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date"
                                   ...
                                   id="opening_date"
                                   name="opening_date"
                                   value="<?= old('opening_date', $vacancy->opening_date) ?>"
                                   required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date"
                                   ...
                                   id="closing_date"
                                   name="closing_date"
                                   value="<?= old('closing_date', $vacancy->closing_date) ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select <?= errors('status') ? 'is-invalid' : '' ?>"
                                ...
                                <option value="On Hold" <?= old('status', $vacancy->status) == 'On Hold' ? 'selected' : '' ?>>On Hold</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select <?= errors('created_by') ? 'is-invalid' : '' ?>"
                                ...
                                <?php foreach ($persons as $person): ?>
                                    <option value="<?= $person->id ?>" <?= old('created_by', $vacancy->created_by) == $person->id ? 'selected' : '' ?>>
                        ...
                        <div class="alert alert-info">
                            <small>
                                ...
                                Last updated: <?= date('F d, Y h:i A', strtotime($vacancy->updated_at)) ?>
                                (Version: <?= $vacancy->version ?>)
                            </small>
                        </div>

                        <div class="d-flex justify-content-between">
                            <a href="/organization_vacancies/<?= $vacancy->id ?>" class="btn btn-secondary">
