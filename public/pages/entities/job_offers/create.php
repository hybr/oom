...
<div class="container-fluid mt-4">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            ...
            <!-- Header -->
            <h1 class="mb-4">
                <i class="bi bi-plus-circle"></i> Add New Job Offer
            </h1>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="/job_offers/store" class="needs-validation" novalidate>
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Select the vacancy application this offer is for</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Enter the position title</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Enter the salary amount</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Select the date the offer was made</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Select the expected joining date</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Select the offer status</div>
                        </div>

                        <div class="d-flex justify-content-between">
                            <a href="/job_offers" class="btn btn-secondary">
                                <i class="bi bi-arrow-left"></i> Cancel
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save"></i> Save Job Offer
                            </button>
                        </div>
                    </form>
                </div>
