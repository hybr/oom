...
-- Domain: SKILLS
-- Description: Common technical and soft skills across multiple categories
...
('1a6f2d8b-7c9e-4a13-b5d8-3e7a9f1c2b4e', 'POPULAR_SKILL', 'Popular Skill', 'Common technical and soft skills across multiple categories', 'SKILLS', 'popular_skill', 1, datetime('now'), datetime('now'));
...
('attr-popskl-001','1a6f2d8b-7c9e-4a13-b5d8-3e7a9f1c2b4e','name','Skill Name','text',1,1,1,'Name of the skill',1, datetime('now'), datetime('now'));

-- =========================================
-- 3. Entity Relationships
-- =========================================
-- Used by: person_skill, organization_skill_requirement
...
('func-popskl-create','1a6f2d8b-7c9e-4a13-b5d8-3e7a9f1c2b4e','create','Create Popular Skill','Create a new popular skill','[{"name":"data","type":"json"}]','void',0,1, datetime('now'), datetime('now')),
('func-popskl-read','1a6f2d8b-7c9e-4a13-b5d8-3e7a9f1c2b4e','read','Read Popular Skill','Read skill by id','[{"name":"id","type":"text"}]','json',0,1, datetime('now'), datetime('now')),
('func-popskl-update','1a6f2d8b-7c9e-4a13-b5d8-3e7a9f1c2b4e','update','Update Popular Skill','Update skill by id','[{"name":"id","type":"text"},{"name":"data","type":"json"}]','void',0,1, datetime('now'), datetime('now')),
('func-popskl-delete','1a6f2d8b-7c9e-4a13-b5d8-3e7a9f1c2b4e','delete','Delete Popular Skill','Delete by id','[{"name":"id","type":"text"}]','void',0,1, datetime('now'), datetime('now')),
('func-popskl-search','1a6f2d8b-7c9e-4a13-b5d8-3e7a9f1c2b4e','search','Search Popular Skills','Search with filters','[{"name":"filters","type":"json"}]','json',0,1, datetime('now'), datetime('now')),
('func-popskl-list-all','1a6f2d8b-7c9e-4a13-b5d8-3e7a9f1c2b4e','list_all','List All Skills','List all available skills','[]','json',1,1, datetime('now'), datetime('now')),
('func-popskl-by-category','1a6f2d8b-7c9e-4a13-b5d8-3e7a9f1c2b4e','get_by_category','Get Skills by Category','Get skills filtered by category','[{"name":"category","type":"text"}]','json',1,1, datetime('now'), datetime('now'));
...
('h-popskl-create','func-popskl-create','sql','sp_create_popular_skill',1, datetime('now')),
('h-popskl-read','func-popskl-read','sql','sp_read_popular_skill',1, datetime('now')),
('h-popskl-update','func-popskl-update','sql','sp_update_popular_skill',1, datetime('now')),
('h-popskl-delete','func-popskl-delete','sql','sp_delete_popular_skill',1, datetime('now')),
('h-popskl-search','func-popskl-search','sql','sp_search_popular_skill',1, datetime('now')),
('h-popskl-list-all','func-popskl-list-all','sql','sp_list_all_popular_skill',1, datetime('now')),
('h-popskl-by-category','func-popskl-by-category','sql','sp_get_skills_by_category',1, datetime('now'));
...
('vr-popskl-name-length','1a6f2d8b-7c9e-4a13-b5d8-3e7a9f1c2b4e','attr-popskl-001','name_min_length','length(value) >= 2','Skill name must be at least 2 characters','error', datetime('now'));
...
-- Verification
-- =========================================
SELECT 'POPULAR_SKILL entity metadata and data installed' AS status;
SELECT COUNT(*) AS skill_count FROM popular_skill;
