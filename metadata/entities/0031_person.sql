...
('p1e1r1s1-0020-0000-0000-000000000001', 'p1e1r1s1-o1n1-4111-a111-b111c111d111', 'username', 'Username', 'text', 0, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, 'Unique username for authentication', 19),
('p1e1r1s1-0021-0000-0000-000000000001', 'p1e1r1s1-o1n1-4111-a111-b111c111d111', 'password_hash', 'Password Hash', 'text', 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, 'Hashed password for authentication', 20),
('p1e1r1s1-0022-0000-0000-000000000001', 'p1e1r1s1-o1n1-4111-a111-b111c111d111', 'is_active', 'Is Active', 'boolean', 0, 0, 0, 0, '1', NULL, NULL, NULL, NULL, 'Whether the user account is active', 21),
('p1e1r1s1-0023-0000-0000-000000000001', 'p1e1r1s1-o1n1-4111-a111-b111c111d111', 'last_login_at', 'Last Login At', 'datetime', 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, 'Last login timestamp', 22),

-- Profile Picture
('p1e1r1s1-0024-0000-0000-000000000001', 'p1e1r1s1-o1n1-4111-a111-b111c111d111', 'profile_picture_media_file_id', 'Profile Picture', 'text', 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, 'Profile picture media file (FK to MEDIA_FILE)', 23);
