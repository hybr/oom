...
('b9f5e4a2-2a87-47d7-a7a0-81f7d3fbb5a2', 'ENUM_EDUCATION_LEVELS', 'Education Levels Enumeration',
 'List of possible education levels for Person Education', 'EDUCATION', 'enum_education_level');

-- ENUM_EDUCATION_LEVELS attributes
INSERT OR IGNORE INTO entity_attribute (id, entity_id, code, name, data_type, is_required, is_label, description)
VALUES
...
INSERT OR IGNORE INTO entity_attribute (id, entity_id, code, name, data_type, is_required, is_label, description)
VALUES
('c8fbb7ea-7157-4986-bffb-d51b3d5185d8', '1e6b403f-5a37-47c3-8d8a-80419e2c9e25', 'person_id', 'Person', 'uuid', 1, 0, 'Reference to PERSON'),
('1f7e5a6e-298c-4e4e-9f3f-8ffbc0f2308c', '1e6b403f-5a37-47c3-8d8a-80419e2c9e25', 'institution', 'Institution', 'text', 1, 0, 'Name of the educational institution'),
('cf24488f-9a89-4d1f-9a36-78b27a342f31', '1e6b403f-5a37-47c3-8d8a-80419e2c9e25', 'start_date', 'Start Date',  'date', 0, 0, 'Start date of course'),
('a22d3d66-bac2-4f02-b9fd-38c2b56ddf1f', '1e6b403f-5a37-47c3-8d8a-80419e2c9e25', 'complete_date', 'Completion Date', 'date', 0, 0, 'Completion date'),
('530db6b9-27a2-489a-a9c2-58ad9f8ed3cb', '1e6b403f-5a37-47c3-8d8a-80419e2c9e25', 'education_level', 'Education Level', 'uuid', 1, 0, 'Reference to ENUM_EDUCATION_LEVELS');
...
INSERT OR IGNORE INTO entity_attribute (id, entity_id, code, name, data_type, is_required, is_label, description)
VALUES
('8e4c59d0-4b6b-4d4b-9c0b-7b7e0a822a87', 'ba480b24-d2a0-42b1-95f3-59f303b775b2', 'person_education_id', 'Person Education', 'uuid', 1, 0, 'Reference to PERSON_EDUCATION'),
('3a5bff77-d4a8-4933-8828-95ff7e38f847', 'ba480b24-d2a0-42b1-95f3-59f303b775b2', 'subject_id', 'Subject', 'uuid', 1, 0, 'Reference to POPULAR_EDUCATION_SUBJECT'),
('ce86c991-93db-4418-977d-b3e2a7c9b5e1', 'ba480b24-d2a0-42b1-95f3-59f303b775b2', 'marks_type', 'Marks Type', 'text', 0, 0, 'Percentage, Grade, CGPA etc.'),
('d85b6a66-12d3-4766-96c0-2a911a9e7c03', 'ba480b24-d2a0-42b1-95f3-59f303b775b2', 'marks', 'Marks', 'number', 0, 0, 'Marks or grade achieved');
...
INSERT OR IGNORE INTO entity_attribute (id, entity_id, code, name, data_type, is_required, is_label, description)
VALUES
('14ae6464-51ac-4a54-8894-71db8b3baf63', '6d6b3a5b-72ac-4ccf-b089-9e8a53b115c2', 'person_id', 'Person', 'uuid', 1, 0, 'Reference to PERSON'),
('f84f88d3-2997-4f04-a8c7-3e9cfbfa33e2', '6d6b3a5b-72ac-4ccf-b089-9e8a53b115c2', 'subject_id', 'Skill', 'uuid', 1, 0, 'Reference to POPULAR_SKILL'),
('6031ab7d-8ce3-4728-8c0b-3b2dc7618a2b', '6d6b3a5b-72ac-4ccf-b089-9e8a53b115c2', 'institution', 'Institution', 'text', 0, 0, 'Training or certifying institution'),
('e48ac2a5-1b4c-45c4-b6a8-42e083478d6a', '6d6b3a5b-72ac-4ccf-b089-9e8a53b115c2', 'level', 'Skill Level', 'text', 0, 0, 'Beginner / Intermediate / Expert'),
('c861e67e-c3de-49a3-8de3-6407b33c8f4c', '6d6b3a5b-72ac-4ccf-b089-9e8a53b115c2', 'start_date', 'Start Date', 'date', 0, 0, 'When skill training started'),
('17a83c06-2e7b-4402-a9a5-786cba5b6d44', '6d6b3a5b-72ac-4ccf-b089-9e8a53b115c2', 'complete_date', 'Completion Date', 'date', 0, 0, 'When skill training ended'),
('17b8b6f7-b94b-4f25-9bbf-10ed9ac57a52', '6d6b3a5b-72ac-4ccf-b089-9e8a53b115c2', 'marks_type', 'Marks Type', 'text', 0, 0, 'Percentage / Grade'),
('7b7d9513-6c73-47b7-b36a-f45ef6a6888b', '6d6b3a5b-72ac-4ccf-b089-9e8a53b115c2', 'marks', 'Marks', 'number', 0, 0, 'Score achieved');
...
('efa84ed4-02c4-4822-d13h-3e9c26d1b62e', '1e6b403f-5a37-47c3-8d8a-80419e2c9e25', 'b9f5e4a2-2a87-47d7-a7a0-81f7d3fbb5a2', 'ManyToOne', 'education_level', 'education_level'),
('cba38ec3-91a3-4821-b02g-4f9d37e2c73f', 'ba480b24-d2a0-42b1-95f3-59f303b775b2', '1e6b403f-5a37-47c3-8d8a-80419e2c9e25', 'ManyToOne', 'person_education', 'person_education_id'),
('dca49fd4-02b4-4932-c13h-5g0e48f3d84g', 'ba480b24-d2a0-42b1-95f3-59f303b775b2', 'e3d54a5a-292e-4b6f-9610-8fb85e43b442', 'ManyToOne', 'subject', 'subject_id'),
